...
# 每次業務 API 請求寫入 public.Log（僅略過 GET /v1/logs、OPTIONS/HEAD、Swagger 路徑）
...
# 掛載順序對齊 OpenAPI 區塊：profile → bank → quiz → 分析 → college → course → prompt → log
# course_settings_router 提供 /bank/course-members（課程成員管理，tag=bank）
